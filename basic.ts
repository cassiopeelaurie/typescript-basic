...
let aa: number[] = [];
aa.push(33);
aa.push("abc"); //🚨 ERROR : Type 'string' is not assignable to parameter of type 'number'
...
cc = {
 ...
 cc = { // 🚨 ERROR : Property 'streetName' is missing in type '{ houseNumber: number; }' but required in type '{ houseNumber: number; streetName: string; }'
   houseNumber: 33
 };
